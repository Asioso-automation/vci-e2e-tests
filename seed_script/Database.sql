...
INSERT [Calculation].[BillOrder] ([Id], [PeriodId], [DsoId], [Date], [SeasonId], [DateOfPayment], [AmountWithoutTax], [Tax], [AmountWithTax], [NumberOfCustomers], [NumberOfMeteringPoints], [NumberOfBills], [Note], [Closed],[GeneratedAdvancePaymentInvoiceFiles]) VALUES (202007, 2007, NULL, CAST(N'2020-07-31' AS Date), N'S', CAST(N'2020-11-25' AS Date), CAST(0.00 AS Decimal(14, 2)), CAST(0.00 AS Decimal(10, 2)), CAST(0.00 AS Decimal(14, 2)), 0, 0, 0, NULL, 1,0)
INSERT [Calculation].[BillOrder] ([Id], [PeriodId], [DsoId], [Date], [SeasonId], [DateOfPayment], [AmountWithoutTax], [Tax], [AmountWithTax], [NumberOfCustomers], [NumberOfMeteringPoints], [NumberOfBills], [Note], [Closed],[GeneratedAdvancePaymentInvoiceFiles]) VALUES (202010, 2010, NULL, CAST(N'2020-10-31' AS Date), N'S', CAST(N'2020-11-25' AS Date), CAST(0.00 AS Decimal(14, 2)), CAST(0.00 AS Decimal(10, 2)), CAST(0.00 AS Decimal(14, 2)), 0, 0, 0, NULL, 0,0)
