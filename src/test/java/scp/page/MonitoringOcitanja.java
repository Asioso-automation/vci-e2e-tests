...
public class MonitoringOcitanja extends PocetnaStranica{
	...
	@FindBy(xpath = "/html/body/div/div[14]/main/div/div/div/div[2]/form/div/div/div[8]/div/div/div[1]/div/div/div[3]/a")
	private WebElement duplaRedovnaGasWE;
	...
	@FindBy(xpath = "/html/body/div/div[14]/main/div/div/div/div[2]/form/div/div/div[8]/div/div/div[1]/div/div/div[4]/a")
	private WebElement analizaPotrosnjeGasWE;
	...
	@FindBy(xpath = "/html/body/div/div[14]/main/div/div/div/div[2]/form/div/div/div[8]/div/div/div[1]/div/div/div[5]/a")
	private WebElement odstupanjaPotrosnjaGasWE;
	...
	public void verifikujMonitoringOcitanjaGas()throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(pokreniMonitoringWE));
		wait.until(ExpectedConditions.elementToBeClickable(neocitanaMjerilaWE));
		wait.until(ExpectedConditions.elementToBeClickable(duplaRedovnaGasWE));
		wait.until(ExpectedConditions.elementToBeClickable(analizaPotrosnjeGasWE));
		wait.until(ExpectedConditions.elementToBeClickable(odstupanjaPotrosnjaGasWE));
	}
