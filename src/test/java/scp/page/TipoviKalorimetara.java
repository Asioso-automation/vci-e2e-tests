...
public class TipoviKalorimetara extends PocetnaStranica{
	...
	public void verifikujTipoveKalorimetara()throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title') and contains(text(), 'Tipovi kalorimetara')]")));
		verifikacijaZajednickihElemenata2("ŠIFARNICI", "TIPOVI KALORIMETARA", "Tipovi kalorimetara", 6, false, false, true, true, true, true, false);
