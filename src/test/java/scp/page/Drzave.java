...
public class Drzave extends PocetnaStranica{
	...
	public void verifikujDrzave()throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title') and contains(text(), 'Države')]")));
		verifikacijaZajednickihElemenata2("Šifarnici", "Države", "Države", 4, false, false, true, true, true, true, false);
