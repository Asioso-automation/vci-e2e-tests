...
public class Reprogrami extends PocetnaStranica{
	...
	public void verifikujReprograme()throws InterruptedException, FileNotFoundException, IOException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title') and contains(text(), 'Reprogrami')]")));
		verifikacijaZajednickihElemenata2("Finansije", "Reprogrami", "Reprogrami", 8, false, false, true, true, true, true, false);
		...
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaIznosReprogramaWE));
