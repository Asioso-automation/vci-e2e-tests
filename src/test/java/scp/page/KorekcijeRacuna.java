...
public class KorekcijeRacuna extends PocetnaStranica{
	...
	public void verifikujKorekcijeRacuna()throws InterruptedException, FileNotFoundException, IOException {
		...
		verifikacijaZajednickihElemenata2("Obračun", "Korekcije Računa", "Korekcije računa", 14, false, false, true, true, true, true, false);
		...
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaBrojRacuna1WE));
		...
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaVrstaKorekcijeWE));
	...
	public void verifikujKorekcijeRacunaSon()throws InterruptedException, FileNotFoundException, IOException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title') and contains(text(), 'Korekcije računa')]")));
		verifikacijaZajednickihElemenata2("Obračun", "Korekcije Računa", "Korekcije računa", 13, false, false, false, true, true, true, false);
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaId1WE));
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaKupac1WE));
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaProstorWE));
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaDatum1WE));
