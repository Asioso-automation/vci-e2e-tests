...
public class KategorijeObjekata extends PocetnaStranica{

	public KategorijeObjekata(WebDriver driver) throws FileNotFoundException, IOException {
		super(driver);
	}
	
	public void verifikujKategorijeObjekata()throws InterruptedException, FileNotFoundException, IOException {
