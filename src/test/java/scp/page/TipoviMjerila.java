...
public class TipoviMjerila extends PocetnaStranica{
	...
	public void verifikujTipoveMjerila()throws InterruptedException, FileNotFoundException, IOException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title') and contains(text(), 'Tipovi mjerila')]")));
		verifikacijaZajednickihElemenata("ŠIFARNICI", "TIPOVI MJERILA", "Tipovi mjerila", 6, false, false, true, true, true, true, false);
