...
public class PX_009_Verifikacija_Sekcije_Nestandardne_Usluge_Test extends BaseTest {

	public PX_009_Verifikacija_Sekcije_Nestandardne_Usluge_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test (description="test prolazi kroz sve stranice iz sekcije NESTANDARDNE USLUGE i verifikuje ih")
	public void px_009_verifikacija_sekcije_nestandardne_usluge_test() throws Exception {
