...
public class PX_042_Dodavanje_Ugovora_Test extends BaseTest {

	public PX_042_Dodavanje_Ugovora_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_042_dodavanje_ugovora_test() throws Exception {
