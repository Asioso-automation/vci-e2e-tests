...
public class QA_028_Izmjena_Ugovor_Test extends BaseTest {

	public QA_028_Izmjena_Ugovor_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void qa_028_izmjena_ugovor_test() throws Exception {
