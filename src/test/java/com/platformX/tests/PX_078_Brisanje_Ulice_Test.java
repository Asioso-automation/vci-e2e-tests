...
public class PX_078_Brisanje_Ulice_Test extends BaseTest {

	public PX_078_Brisanje_Ulice_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_078_brisanje_ulice_test() throws Exception {
