...
public class PX_017_Umanjenja_Cijene_CRUD_Test extends BaseTest {
	...
	public void px_017_1_dodavanje_umanjenja_cijene_test() throws Exception {
		...
		UmanjenjaCijene umanjenjaCijene = homePage.navigateOnPagePX(UmanjenjaCijene.class, "Obračun", "Umanjenja cijene");
		...
		umanjenjaCijene.pretraziStavkuInt(homePage.filterIntKolona1WE, homePage.filterInt1Kolona1WE, brojMjeseci);
		umanjenjaCijene.verifikujUmanjenjaCijene();
	...
	public void px_017_3_uredjivanje_umanjenja_cijene_test() throws Exception {
		...
		umanjenjaCijene.verifikujPoruku("Uspješno završeno.");
		umanjenjaCijene.pretraziStavkuInt(homePage.filterIntKolona1WE, homePage.filterInt1Kolona1WE, noviBrojMjeseci);
		umanjenjaCijene.verifikujUmanjenjaCijene();
