...
public class QA_026_Deaktiviraj_Ugovor_Test extends BaseTest {
	...
	@Test
	public void qa_026_deaktiviraj_ugovor_test() throws Exception {
		...
		String mjernoMjesto = ugovoriPage.dodajUgovor(kupac, "7 - Kategorija cijene 2", "15.07.2020.", "15.07.2020.", "61100265 - 36Z0100154X", true);
		ugovoriPage.verifikujUgovori();
