...
public class QA_018_Dodavanje_Ugovora_Test extends BaseTest {

	public QA_018_Dodavanje_Ugovora_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void qa_018_dodavanje_ugovora_test() throws Exception {
