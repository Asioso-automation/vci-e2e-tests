...
public class PX_024_Brisanje_Banke_Test extends BaseTest {

	public PX_024_Brisanje_Banke_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_024_brisanje_banke_test() throws Exception {
