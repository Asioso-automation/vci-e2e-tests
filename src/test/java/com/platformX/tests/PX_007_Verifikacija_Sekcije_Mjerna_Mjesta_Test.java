...
public class PX_007_Verifikacija_Sekcije_Mjerna_Mjesta_Test extends BaseTest {

	public PX_007_Verifikacija_Sekcije_Mjerna_Mjesta_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test (description="test prolazi kroz sve stranice iz sekcije MJERNA MJESTA i verifikuje ih")
	public void px_007_verifikacija_sekcije_mjerna_mjesta_test() throws Exception {
