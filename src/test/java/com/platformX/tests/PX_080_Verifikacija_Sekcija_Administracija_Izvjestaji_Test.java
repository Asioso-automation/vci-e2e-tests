...
public class PX_080_Verifikacija_Sekcija_Administracija_Izvjestaji_Test extends BaseTest {

	public PX_080_Verifikacija_Sekcija_Administracija_Izvjestaji_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test (description="test prolazi kroz sve stranice iz sekcija ADMINISTRACIJA i IZVJESTAJI i verifikuje ih")
	public void px_080_verifikacija_sekcija_administracija_izvjestaji_test() throws Exception {
