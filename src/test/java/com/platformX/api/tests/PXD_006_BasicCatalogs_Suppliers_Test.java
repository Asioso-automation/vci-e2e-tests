...
public class PXD_006_BasicCatalogs_Suppliers_Test extends BaseTest {
	...
	public PXD_006_BasicCatalogs_Suppliers_Test() throws IOException {
		super();
	}
	    
	@Test(description = "positive test case")
	public void pxd_006_01_get_supplier_test1() throws Exception {
		//PXD UI
	...
	public void pxd_006_02_get_supplier_test2() throws Exception {
		// API
		Response response1 = restApiBase.methodPOST("http://10.10.10.21:8086/api/Auth/Authenticate",
				Payloads.pxdAuth("admin", "staging"));
		assertEquals(response1.getStatusCode(), 200);
