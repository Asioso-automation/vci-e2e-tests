...
public class PXD_007_BasicCatalogs_Suppliers_Test extends BaseTest {
	...
	public void pxd_007_01_get_supplier_test1() throws Exception {
		...
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Get/" + PageBase.id);
	...
	public void pxd_007_01_get_supplier_test2() {
		...
		Response response = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Get/1");
	...
	public void pxd_007_01_get_supplier_test4() throws Exception {
		...
		// Get Supplier
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Get/" + PageBase.wrongIdShort);
	...
	public void pxd_007_02_post_suppliers_list_test1() throws Exception {
		...
		// Post Suppliers List
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPOSTresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/List", Payloads.pxdBasicList(0, 10, "id", "DESC"));
		assertEquals(response2.getStatusCode(), 200);
		JsonPath jp2 = new JsonPath(response2.asString());
	...
	public void pxd_007_03_get_supplier_lookup_test1() throws Exception {
		...
		// Get Supplier Lookup
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Lookup?Keyword=" + PageBase.id + "&Id=" + PageBase.id);
		assertEquals(response2.getStatusCode(), 200);
		JsonPath jp2 = new JsonPath(response2.asString());
		assertNotNull(jp2.getString("id"), "Id not forwarded");
	...
	public void pxd_007_03_get_supplier_lookup_test2() throws Exception {
		...
		// Get Supplier Lookup
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Lookup?Keyword=" + PageBase.wrongIdLong + "&Id=" + PageBase.wrongIdLong);
		assertEquals(response2.getStatusCode(), 200);
	...
	public void pxd_007_04_create_supplier_test1() throws Exception {
		...
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPOSTresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Create", Payloads.pxdSupplierCreate("1111111111111111", "Snabdjevac", 6, 78000));
		assertEquals(response2.getStatusCode(), 200);
	...
	public void pxd_007_05_update_supplier_test1() throws Exception {
		...
		// Put Supplier Update
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPUTresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Update/" + PageBase.id1, Payloads.pxdSupplierUpdate("1111111111111111", PageBase.id1, "Snabdjevac 1", 6, "6 - Banja Luka", 78000, "78000 - Banja Luka"));
	...
	public void pxd_007_06_delete_supplier_test1() throws Exception {
		...
		// Delete Supplier
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodDELETEresponse("http://10.10.10.21:8086/api/BasicCatalogs/Suppliers/Delete/" + PageBase.id1);
		assertEquals(response2.getStatusCode(), 204);
		assertEquals(response2.print(), "");
	}
