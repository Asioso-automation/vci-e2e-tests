...
public class PXD_BasicCatalogs_002_FieldUnits_Tests extends RestApiBase {
	
	public PXD_BasicCatalogs_002_FieldUnits_Tests() throws IOException {
		super();
	}

	@Test(description = "positive test case: get created field unit", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_01_get_field_unit_test1() throws Exception {
		...
		String[] parameters = {"id", "name", "printName", "placeText", "companyText"};
		verifyNotNull(jp, parameters);
	}
	
	@Test(description = "negative test case: bearer token missing")
	public void pxd_basicCatalogs_002_01_get_field_unit_test2() {
	...
	public void pxd_basicCatalogs_002_01_get_field_unit_test3() {
		addHeader("Authorization", "Bearer " + Helper.getRandomNumber(10));
		methodGET(api_properties.getValue("FIELD.UNITS.GET") + Helper.getRandomNumber(1), 401);
	}
		
	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_01_get_field_unit_test4() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
		methodGET(api_properties.getValue("FIELD.UNITS.GET") + Helper.getRandomNumber(6), 404);
	}
	
	@Test(description = "positive test case: list", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_02_post_field_units_list_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case: lookup", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_03_get_field_unit_lookup_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_03_get_field_unit_lookup_test2() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	public void pxd_basicCatalogs_002_04_create_field_unit_test1() throws Exception {
	...
	@Test(description = "positive test case: update field unit", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_05_update_field_unit_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case: delete field unit", dependsOnMethods = { "pxd_basicCatalogs_002_04_create_field_unit_test1" })
	public void pxd_basicCatalogs_002_06_delete_field_unit_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
