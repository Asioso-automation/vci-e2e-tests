...
public class PXD_008_BasicCatalogs_Readers_Test extends BaseTest {
	...
	public void pxd_008_01_get_reader_test1() throws Exception {
		...
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Get/" + PageBase.id);
	...
	public void pxd_008_01_get_reader_test2() {
		...
		Response response = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Get/1");
	...
	public void pxd_008_01_get_reader_test4() throws Exception {
		...
		// Get Reader
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Get/" + PageBase.wrongIdLong);
	...
	public void pxd_008_02_post_readers_list_test1() throws Exception {
		...
		// Post Readers List
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPOSTresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/List", Payloads.pxdBasicList(0, 10, "id", "DESC"));
		assertEquals(response2.getStatusCode(), 200);
		JsonPath jp2 = new JsonPath(response2.asString());
	...
	public void pxd_008_03_get_reader_lookup_test1() throws Exception {
		...
		// Get Reader Lookup
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Lookup?Keyword=" + PageBase.id + "&Id=" + PageBase.id);
		assertEquals(response2.getStatusCode(), 200);
		JsonPath jp2 = new JsonPath(response2.asString());
		assertNotNull(jp2.getString("id"), "Id not forwarded");
	...
	public void pxd_008_03_get_reader_lookup_test2() throws Exception {
		...
		// Get Reader Lookup
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGETresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Lookup?Keyword=" + PageBase.wrongIdLong + "&Id=" + PageBase.wrongIdLong);
		assertEquals(response2.getStatusCode(), 200);
	...
	public void pxd_008_04_create_reader_test1() throws Exception {
		...
		// Post Reader Create
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPOSTresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Create", Payloads.pxdReaderCreate("2023-09-01", 308, "Citac"));
		assertEquals(response2.getStatusCode(), 200);
	...
	public void pxd_008_05_update_reader_test1() throws Exception {
		...
		// Put Reader Update
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPUTresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Update/" + PageBase.id1, Payloads.pxdReaderUpdate("2023-09-01", "2023-09-02", 308, "308 - Pale", 5, "5 - Pale", PageBase.id1, "Citac 1"));
		assertEquals(response2.getStatusCode(), 204);
	}
	
	@Test(description = "positive test case", dependsOnMethods = { "pxd_008_05_update_reader_test1" })
	public void pxd_008_06_delete_reader_test1() throws Exception {
		...
		// Delete Reader
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodDELETEresponse("http://10.10.10.21:8086/api/BasicCatalogs/Readers/Delete/" + PageBase.id1);
		assertEquals(response2.getStatusCode(), 204);
		assertEquals(response2.print(), "");
	}
