...
public class PXD_004_BasicCatalogs_Companies_Test extends BaseTest {
	...
	public void pxd_004_01_get_company_test1() throws Exception {
		...
		Response response2 = restApiBase.methodGET("http://10.10.10.21:8086/api/BasicCatalogs/Companies/Get/" + PageBase.id);
	...
	public void pxd_004_01_get_company_test4() throws Exception {
		...
		// Get Company
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGET("http://10.10.10.21:8086/api/BasicCatalogs/Companies/Get/" + PageBase.wrongIdShort);
		assertEquals(response2.getStatusCode(), 404);
		assertEquals(response2.print(), "\"Entity \\\"Customer\\\" (" + PageBase.wrongIdShort + ") was not found.\"");					// "Customer" > "Company" ?
	}
	...
	public void pxd_004_02_post_companies_list_test1() throws Exception {
		...
		// Post Companies List
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodPOST("http://10.10.10.21:8086/api/BasicCatalogs/Companies/List", Payloads.pxdBasicList(0, 10, "id", "DESC"));
		assertEquals(response2.getStatusCode(), 200);
		JsonPath jp2 = new JsonPath(response2.asString());
	...
	public void pxd_004_03_get_company_lookup_test2() throws Exception {
		...
		// Get Company Lookup
		restApiBase.addHeader("Authorization", "Bearer " + token);
		Response response2 = restApiBase.methodGET("http://10.10.10.21:8086/api/BasicCatalogs/Companies/Lookup?Keyword=" + PageBase.wrongIdShort + "&Id=" + PageBase.wrongIdShort);
		assertEquals(response2.getStatusCode(), 200);
