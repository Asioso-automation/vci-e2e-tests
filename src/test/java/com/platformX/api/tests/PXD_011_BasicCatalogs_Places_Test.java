...
public class PXD_011_BasicCatalogs_Places_Test extends BaseTest {
	...
	public void pxd_011_02_get_place_test2() throws Exception {
		// API
		Response response1 = restApiBase.methodPOST("http://10.10.10.21:8086/api/Auth/Authenticate",
				Payloads.pxdAuth("admin", "staging"));
		assertEquals(response1.getStatusCode(), 200);
	...
	@Test(description = "positive test case")
	public void pxd_011_03_post_places_list_test1() throws Exception {
		// API
		Response response1 = restApiBase.methodPOST("http://10.10.10.21:8086/api/Auth/Authenticate",
				Payloads.pxdAuth("admin", "staging"));
		assertEquals(response1.getStatusCode(), 200);
...
//  TODO	/api/BasicCatalogs/Places/Lookup
//			/api/BasicCatalogs/Places/Create
