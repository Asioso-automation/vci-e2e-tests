...
public class PXD_BasicCatalogs_011_InstallmentPersons_Tests extends RestApiBase {

	public PXD_BasicCatalogs_011_InstallmentPersons_Tests() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_01_get_installment_person_test1() throws Exception {
	...
	public void pxd_basicCatalogs_011_01_get_installment_person_test2() {
	...
	public void pxd_basicCatalogs_011_01_get_installment_person_test3() {
		addHeader("Authorization", "Bearer " + Helper.getRandomNumber(10));
		methodGET(api_properties.getValue("INSTALLMENT.PERSONS.GET") + Helper.getRandomNumber(1), 401);
	}

	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_01_get_installment_person_test4() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
...
//		assertEquals(response2.print(), "\"Entity \\\"InstallmentPerson\\\" (" + PageBase.wrongIdLong + ") was not found.\"");
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_02_post_installment_persons_list_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_03_get_installment_person_lookup_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_03_get_installment_person_lookup_test2() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	public void pxd_basicCatalogs_011_04_create_installment_person_test1() throws Exception {
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_05_update_installment_person_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_011_04_create_installment_person_test1" })
	public void pxd_basicCatalogs_011_06_delete_installment_person_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
