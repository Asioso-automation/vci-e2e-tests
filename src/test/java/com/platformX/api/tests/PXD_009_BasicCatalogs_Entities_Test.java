...
public class PXD_009_BasicCatalogs_Entities_Test extends RestApiBase {
	...
	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_009_04_create_entity_test1" })
