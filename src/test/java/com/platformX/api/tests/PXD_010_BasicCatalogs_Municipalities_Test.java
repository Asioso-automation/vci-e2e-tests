...
public class PXD_010_BasicCatalogs_Municipalities_Test extends BaseTest {
	...
	public void pxd_010_02_get_municipality_test2() throws Exception {
		// API
		Response response1 = restApiBase.methodPOST("http://10.10.10.21:8086/api/Auth/Authenticate",
				Payloads.pxdAuth("admin", "staging"));
		assertEquals(response1.getStatusCode(), 200);
	...
	@Test(description = "positive test case")
	public void pxd_010_03_post_municipalities_list_test1() throws Exception {
		// API
		Response response1 = restApiBase.methodPOST("http://10.10.10.21:8086/api/Auth/Authenticate",
				Payloads.pxdAuth("admin", "staging"));
		assertEquals(response1.getStatusCode(), 200);
...
//	TODO	/api/BasicCatalogs/Municipalities/Lookup
//			/api/BasicCatalogs/Municipalities/Create
//			/api/BasicCatalogs/Municipalities/Update/{id}
//			/api/BasicCatalogs/Municipalities/Delete/{id}
