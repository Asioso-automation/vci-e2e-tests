...
public class PXD_BasicCatalogs_012_InstallmentPersonLocations_Tests extends RestApiBase {

	public PXD_BasicCatalogs_012_InstallmentPersonLocations_Tests() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test(description = "Test data - Installment person creation")
	public void pxd_basicCatalogs_012_00_create_installment_person_test() throws Exception {
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	...
	public void pxd_basicCatalogs_012_01_get_installment_person_location_test2() {
	...
	public void pxd_basicCatalogs_012_01_get_installment_person_location_test3() {
		addHeader("Authorization", "Bearer " + Helper.getRandomNumber(10));
		methodGET(api_properties.getValue("INSTALLMENT.PERSON.LOCATIONS.GET") + Helper.getRandomNumber(1), 401);
	}
	
	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	public void pxd_basicCatalogs_012_01_get_installment_person_location_test4() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
...
//		assertEquals(response2.print(), "\"Entity \\\"InstallmentPersonLocation\\\" (" + PageBase.wrongIdLong + ") was not found.\"");
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	public void pxd_basicCatalogs_012_02_post_installment_persons_location_list_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	public void pxd_basicCatalogs_012_03_get_active_installment_person_lookup_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "negative test case: wrong id", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	public void pxd_basicCatalogs_012_03_get_active_installment_person_location_lookup_test2() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_012_00_create_installment_person_test" })
	public void pxd_basicCatalogs_012_04_create_installment_persons_location_test1() throws Exception {
		GlobalVariables.token = authorize();
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	public void pxd_basicCatalogs_012_05_update_installment_person_location_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
	...
	@Test(description = "positive test case", dependsOnMethods = { "pxd_basicCatalogs_012_04_create_installment_persons_location_test1" })
	public void pxd_basicCatalogs_012_06_delete_installment_person_location_test1() throws Exception {
		addHeader("Authorization", "Bearer " + GlobalVariables.token);
