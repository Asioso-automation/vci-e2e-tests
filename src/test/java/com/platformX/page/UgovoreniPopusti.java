...
public class UgovoreniPopusti extends PocetnaStranica {
	...
	public void verifikujUgovoreniPopusti() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Ugovoreni popusti')]")));
		verifikacijaZajednickihElemenata2("Kupci", "Ugovoreni Popusti", "Ugovoreni popusti", 8, false, false, true, true, true, true, false);
