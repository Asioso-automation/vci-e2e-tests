...
public class Entiteti extends PocetnaStranica {
	...
	public void verifikujEntitete() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Entiteti')]")));
		verifikacijaZajednickihElemenata2("Šifarnici", "Entiteti", "Entiteti", 3, false, false, true, true, true, true, false);
