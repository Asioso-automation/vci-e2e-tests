...
public class SveUplate extends PocetnaStranica {
	...
	public void verifikujSveUplate() throws FileNotFoundException, IOException, InterruptedException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Sve uplate')]")));
		verifikacijaZajednickihElemenata2("Finansije", "Sve Uplate", "Sve uplate", 15, false, false, false, true, true, true, false);
