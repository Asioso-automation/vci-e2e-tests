...
public class IzvodiOtvorenihStavkiPoODSu extends PocetnaStranica {
	...
	public void verifikujIzvodiOtvorenihStavki() throws InterruptedException, FileNotFoundException, IOException {
		...
		assertTrue(sekcijaBtnWE.getText().trim().equals("KUPCI"), "IzvodiOtvorenihStavki: Naziv sekcije nije dobar!");
		assertTrue(stranicaBtnWE.getText().trim().equals("IZVODI OTVORENIH STAVKI PO ODS-U"), "IzvodiOtvorenihStavki: Naziv stranice nije dobar!");
		assertTrue(naslovStraniceWE.getText().trim().equals("IZVODI OTVORENIH STAVKI PO ODS-U"), "IzvodiOtvorenihStavki: Naziv stranice nije dobar!");
		assertTrue(brojKolona().size() == 9, "IzvodiOtvorenihStavki: Broj kolona nije dobar! ");
	}
