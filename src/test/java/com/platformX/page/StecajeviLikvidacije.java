...
public class StecajeviLikvidacije extends PocetnaStranica {
	...
	public void verifikujStecajeviLikvidacije() throws FileNotFoundException, IOException, InterruptedException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Stečajevi')]")));
		verifikacijaZajednickihElemenata2("Pravni Odnosi", "Stečajevi/Likvidacije", "Stečajevi/Likvidacije", 7, false, false, false, true, true, true, false);
