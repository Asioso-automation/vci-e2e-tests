...
public class Organizacije extends PocetnaStranica {
	...
	public void verifikujOrganizacije() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Organizacije ')]")));
		verifikacijaZajednickihElemenata2("Šifarnici", "Organizacije", "Organizacije", 12, false, false, false, true, true, true, false);
