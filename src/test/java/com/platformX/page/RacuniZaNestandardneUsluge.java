...
public class RacuniZaNestandardneUsluge extends PocetnaStranica {
	...
	public void verifikujRacuniZaNestandardneUsluge() throws InterruptedException, FileNotFoundException, IOException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Računi za')]")));
		verifikacijaZajednickihElemenata2("Nestandardne Usluge", "Računi Za Nestandardne Usluge", "Računi za nestandardne usluge", 13, false, false, false, true, true, true, false);
