...
public class Kamate extends PocetnaStranica {
	...
	public void verifikujKamate() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Kamate')]")));
		verifikacijaZajednickihElemenata2("Obračun", "Kamate", "Kamate", 7, false, false, false, true, true, true, false);
