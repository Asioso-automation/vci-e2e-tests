...
public class IskljucenjaOdStraneODSa extends PocetnaStranica {
	...
	public void verifikujIskljucenjaOdStraneODSa() throws FileNotFoundException, IOException, InterruptedException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Isključenja od')]")));
		verifikacijaZajednickihElemenata2("Pravni Odnosi", "Isključenja Od Strane ODS-a", "Isključenja od strane ODS-a", 8, false, false, false, true, true, true, false);
