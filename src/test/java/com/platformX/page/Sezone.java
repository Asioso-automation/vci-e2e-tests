...
public class SezonePage extends PocetnaStranica {

	public SezonePage(WebDriver driver) throws FileNotFoundException, IOException {
		super(driver);
	}

	public void verifikujSezone() throws InterruptedException {
