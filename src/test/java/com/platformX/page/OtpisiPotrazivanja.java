...
public class OtpisiPotrazivanja extends PocetnaStranica {
	...
	public void verifikujOtpisiPotrazivanja() throws FileNotFoundException, IOException, InterruptedException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Otpisi')]")));
		verifikacijaZajednickihElemenata2("Pravni Odnosi", "Otpisi Potraživanja", "Otpisi potraživanja", 7, false, false, true, true, true, true, false);
