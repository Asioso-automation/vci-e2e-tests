...
public class Prijave extends PocetnaStranica {
	...
	public void verifikujPrijave()throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Prijave')]")));
		verifikacijaZajednickihElemenata2("Kupci-proizvođači", "Prijave", "Prijave", 10, false, false, true, true, true, true, false);
