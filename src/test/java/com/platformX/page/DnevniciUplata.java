...
public class DnevniciUplata extends PocetnaStranica {
	...
	public void verifikujDnevniciUplata() throws FileNotFoundException, IOException, InterruptedException {
		...
		verifikacijaZajednickihElemenata2("Finansije", "Dnevnici Uplata", "Dnevnici uplata", 14, false, false, true, true, true, true, false);
	...
	public void verifyDnevnikUplata(String bankaTabela, String ziroRacunTabela) throws Exception {
		navigateOnPagePX(DnevniciUplata.class, "Finansije", "Dnevnici uplata");
		wait.until(ExpectedConditions.invisibilityOf(obradaModalWE));
