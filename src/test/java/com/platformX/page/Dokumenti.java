...
public class Dokumenti extends PocetnaStranica {
	...
	public void verifikujDokumenti()throws InterruptedException, FileNotFoundException, IOException {
		...
		assertTrue(sekcijaBtnWE.getText().trim().equals("KUPCI-PROIZVOĐAČI"), "Dokumenti: Naziv sekcije nije dobar!");
		assertTrue(stranicaBtnWE.getText().trim().equals("DOKUMENTI"), "Dokumenti: Naziv stranice nije dobar!");
		assertTrue(naslovStraniceWE.getText().trim().equals("DOKUMENTI"), "Dokumenti: Naziv stranice nije dobar!");
		assertTrue(brojKolona().size() == 5, "Dokumenti: Broj kolona nije dobar! ");
	}
