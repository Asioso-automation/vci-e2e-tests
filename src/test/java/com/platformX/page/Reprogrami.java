...
public class Reprogrami extends PocetnaStranica {
	...
	public void verifikujReprogrami() throws FileNotFoundException, IOException, InterruptedException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Reprogrami')]")));
		verifikacijaZajednickihElemenata2("Finansije", "Reprogrami", "Reprogrami", 14, false, false, true, true, true, true, true);
