...
public class FizickaLica extends PocetnaStranica {
	...
	public void verifikujFizickaLica() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Fizička lica')]")));
		verifikacijaZajednickihElemenata2("Kupci", "Fizička Lica", "Fizička lica", 9, false, false, true, true, true, true, false);
