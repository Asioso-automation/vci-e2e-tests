...
public class PravnaLica extends PocetnaStranica {
	...
	@FindBy(xpath = "//div[3]/div[2]/div/div/div[1]/div/input")
	...
	public void verifikujPravnaLica() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Pravna lica')]")));
		verifikacijaZajednickihElemenata2("Kupci", "Pravna Lica", "Pravna lica", 13, false, false, true, true, true, true, false);
	    ...
	    wait.until(ExpectedConditions.visibilityOf(kolone.kolonaUStecajuWE));
