...
public class ZahtjeviZaIskljucenje extends PocetnaStranica {
	...
	public void verifikujZahtjeviZaIskljucenje() throws FileNotFoundException, IOException, InterruptedException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Zahtjevi za')]")));
		verifikacijaZajednickihElemenata2("Pravni Odnosi", "Zahtjevi Za Isključenje", "Zahtjevi za isključenje", 10, false, true, false, true, true, true, false);
