...
public class OpomenePredUtuzenje extends PocetnaStranica{
	...
	public void verifikujOpomenePredUtuzenje() throws FileNotFoundException, IOException, InterruptedException {
		...
		verifikacijaZajednickihElemenata2("Pravni Odnosi", "Opomene Pred Utuženje", "Opomene pred utuženje", 16, false, false, false, false, true, true, false);
