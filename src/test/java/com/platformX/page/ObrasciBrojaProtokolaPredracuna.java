...
public class ObrasciBrojaProtokolaPredracuna extends PocetnaStranica{

	public ObrasciBrojaProtokolaPredracuna(WebDriver driver) throws FileNotFoundException, IOException {
		super(driver);
	}
	...
	public void verifikujObrasciBrojaProtokolaPredracuna() throws FileNotFoundException, IOException, InterruptedException {
		...
		verifikacijaZajednickihElemenata2("Nestandardne Usluge", "Obrasci Broja Protokola Predračuna", "Obrasci broja protokola predračuna", 5, false, false, true, true, true, true, false);
