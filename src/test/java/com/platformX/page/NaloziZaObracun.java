...
public class NaloziZaObracun extends PocetnaStranica {
	...
	public void verifikujNaloziZaObracun() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title body-1 ml-0 pl-0 text-default') and starts-with(., ' Nalozi')]")));
		verifikacijaZajednickihElemenata2("Obračun","Nalozi Za Obračun","Nalozi za obračun", 17, false, false, false, true, true, true, false);
