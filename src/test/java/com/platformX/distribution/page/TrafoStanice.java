...
public class TrafoStanice extends PocetnaStranica {
	...
	public String dodajTrafostanicu()throws Exception{
		...
		fizickaLokacijaWE.sendKeys(Helper.getRandomNumber(2));
		Thread.sleep(1000);
	...
	public String izmjeniTrafostanicu(String naziv)throws InterruptedException{
