...
public class SistemiZastiteOdPrenapona extends PocetnaStranicaPXD {
	...
	public void verifikujSistemiZastiteOdPrenapona() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-default') and starts-with(., ' Sistemi zaštite od prenapona')]")));
		verifikacijaZajednickihElemenata("Šifarnici", "Sistemi Zaštite Od Prenapona", "Sistemi zaštite od prenapona", 3, false, false, true, true, true, true, false);
