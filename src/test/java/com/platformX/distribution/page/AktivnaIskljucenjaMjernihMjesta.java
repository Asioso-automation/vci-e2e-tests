...
public class AktivnaIskljucenjaMjernihMjesta extends PocetnaStranica {
	...
	public void verifikujAktivnaIskljucenjaMjernihMjesta() throws InterruptedException, FileNotFoundException, IOException {
		...
		assertTrue(stranicaBtnWE.getText().trim().equals("AKTIVNA ISKLJUČENJA MJERNIH MJESTA"), "AktivnaIskljucenjaMjernihMjesta: Naziv stranice nije dobar!");
		assertTrue(naslovStranice1WE.getText().trim().equals("AKTIVNA ISKLJUČENJA MJERNIH MJESTA"), "AktivnaIskljucenjaMjernihMjesta: Naziv stranice nije dobar!");
