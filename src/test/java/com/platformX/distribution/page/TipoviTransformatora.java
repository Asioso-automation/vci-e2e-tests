...
public class TipoviTransformatora extends PocetnaStranicaPXD {
	...
	public void verifikujTipoviTransformatora() throws InterruptedException, FileNotFoundException, IOException {
		...
		verifikacijaZajednickihElemenata2("Šifarnici", "Tipovi Transformatora", "Tipovi transformatora", 6, false, false, true, true, true, true, false);
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaIdWE));
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaNazivWE));
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaVrsta1WE));
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaProizvodjac1WE));
