...
public class DnevniciUplata extends PocetnaStranicaPXD {
	...
	public void verifikujDnevniciUplata() throws InterruptedException, FileNotFoundException, IOException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-default') and starts-with(., ' Dnevnici uplata')]")));
		verifikacijaZajednickihElemenata2("Finansije", "Dnevnici Uplata", "Dnevnici uplata", 10, false, false, true, true, true, true, false);
