...
public class OcitanjaBrojila extends PocetnaStranicaPXD {
	...
	public void verifikujOcitanjaBrojila()throws InterruptedException, FileNotFoundException, IOException {
		...
		verifikacijaZajednickihElemenata2("Očitanja", "Očitanja Brojila", "Očitanja brojila", 20, false, false, true, true, true, true, true);
		...
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaKorigovanoWE));
