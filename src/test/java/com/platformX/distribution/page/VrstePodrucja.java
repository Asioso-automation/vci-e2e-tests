...
public class VrstePodrucja extends PocetnaStranicaPXD {
	...
	public void verifikujVrstePodrucja() throws InterruptedException, FileNotFoundException, IOException {
		...
		verifikacijaZajednickihElemenata("ŠIFARNICI", "VRSTE PODRUČJA", "VRSTE PODRUČJA", 3, false, false, true, true, true, true, false);
