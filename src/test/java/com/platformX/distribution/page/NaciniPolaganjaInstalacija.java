...
public class NaciniPolaganjaInstalacija extends PocetnaStranica {
	...
	public void verifikujNaciniPolaganjaInstalacija() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-uppercase') and starts-with(., ' Načini polaganja instalacija')]")));
		...
		assertTrue(sekcijaBtnWE.getText().trim().equals("ŠIFARNICI"), "NaciniPolaganjaInstalacija: Naziv sekcije nije dobar!");
		assertTrue(stranicaBtnWE.getText().trim().equals("NAČINI POLAGANJA INSTALACIJA"), "NaciniPolaganjaInstalacija: Naziv stranice nije dobar!");
