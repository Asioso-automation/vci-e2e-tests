...
public class UsloviPlacanja extends PocetnaStranicaPXD {
	...
	public void verifikujUsloviPlacanja() throws InterruptedException, FileNotFoundException, IOException {
		Kolone kolone = new Kolone(driver);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-default') and starts-with(., ' Uslovi plaćanja')]")));
		verifikacijaZajednickihElemenata2("Šifarnici", "Uslovi Plaćanja", "Uslovi plaćanja", 3, false, false, true, true, true, true, false);
