...
public class LokacijaBrojila extends PocetnaStranicaPXD {
	...
	public void verifikujLokacijaBrojila() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-default') and starts-with(., ' Lokacija brojila')]")));
		verifikacijaZajednickihElemenata("Brojila", "Lokacija Brojila", "Lokacija brojila", 3, false, false, true, true, true, true, false);
