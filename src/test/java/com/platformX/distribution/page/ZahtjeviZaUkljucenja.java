...
public class ZahtjeviZaUkljucenja extends PocetnaStranica {
	...
	public void verifikujZahtjeviZaUkljucenja() throws InterruptedException, FileNotFoundException, IOException {
		...
		assertTrue(stranicaBtnWE.getText().trim().equals("ZAHTJEVI ZA UKLJUČENJA"), "ZahtjeviZaUkljucenja: Naziv stranice nije dobar!");
		assertTrue(naslovStraniceWE.getText().trim().equals("ZAHTJEVI ZA UKLJUČENJA (PROCES 16)"), "ZahtjeviZaUkljucenja: Naziv stranice nije dobar!");
