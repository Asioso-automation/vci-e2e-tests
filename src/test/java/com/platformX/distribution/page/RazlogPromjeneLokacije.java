...
public class RazlogPromjeneLokacije extends PocetnaStranicaPXD {
	...
	public void verifikujRazlogPromjeneLokacije() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-default') and starts-with(., ' Razlog promjene lokacije')]")));
		verifikacijaZajednickihElemenata("Brojila", "Razlog Promjene Lokacije", "Razlog promjene lokacije", 3, false, false, true, true, true, true, false);
