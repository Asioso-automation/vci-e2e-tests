...
public class Snabdjevaci extends PocetnaStranica {
	...
	public void verifikujSnabdjevaci() throws InterruptedException, FileNotFoundException, IOException {
		...
		assertTrue(sekcijaBtnWE.getText().trim().equals("ŠIFARNICI"), "Snabdjevaci: Naziv sekcije nije dobar!");
		assertTrue(stranicaBtnWE.getText().trim().equals("SNABDJEVAČI"), "Snabdjevaci: Naziv stranice nije dobar!");
		assertTrue(naslovStraniceWE.getText().trim().equals("SNABDJEVAČI"), "Snabdjevaci: Naziv stranice nije dobar!");
		assertTrue(brojKolona().size() == 12, "Snabdjevaci: Broj kolona nije dobar! ");
	}
