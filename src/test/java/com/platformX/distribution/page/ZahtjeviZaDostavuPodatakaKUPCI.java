...
public class ZahtjeviZaDostavuPodatakaKUPCI extends PocetnaStranica {
	...
	public void verifikujZahtjeviZaDostavuPodatakaKUPCI() throws InterruptedException, FileNotFoundException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-uppercase') and starts-with(., ' Zahtjevi za dostavu podataka')]")));
		verifyCommonElements("KUPCI", "ZAHTJEVI ZA DOSTAVU PODATAKA", "ZAHTJEVI ZA DOSTAVU PODATAKA (PROCES 14)", 8, false, false, false, true, true, true, false);
