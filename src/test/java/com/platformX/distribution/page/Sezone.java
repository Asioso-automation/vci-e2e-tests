...
public class Sezone extends PocetnaStranicaPXD {
	...
	public WebElement[] columns = {kolone.kolonaIdWE, kolone.kolonaNazivWE, kolone.kolonaOdWE, kolone.kolonaDoWE};
	
	public WebElement[] buttons = {preuzmiExcelBtnWE, ukloniFiltereBtnWE, osvjeziBtnWE};

	public void navigirajVerifikujSezone() throws Exception {
		navigateOnPage(Sezone.class, "Tarifni sistem", "Sezone");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//div[contains(@class, 'v-toolbar__title subtitle-2 ml-0 pl-0 text-default') and starts-with(., ' Sezone')]")));
		verifikacijaStranice("Tarifni sistem", "Sezone", "Sezone", 0, columns, buttons);
	}
