...
public class KorekcijeEnergetskihObracuna extends PocetnaStranicaPXD {
	...
	public void verifikujKorekcijeEnergetskihObracuna()throws InterruptedException, FileNotFoundException, IOException {
		...
		verifikacijaZajednickihElemenata("Obračun", "Korekcije Energetskih Obračuna", "Korekcije energetskih obračuna", 18, false, false, false, true, true, true, false);
		...
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaDatumOdbijanjaWE));
		...
		wait.until(ExpectedConditions.visibilityOf(kolone.kolonaKvarUklopnogSataWE));
	}
