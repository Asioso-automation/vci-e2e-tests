...
public class PX_DIST_Uredjivanje_Terenske_Jedinice_Test extends BaseTest {
	
	public PX_DIST_Uredjivanje_Terenske_Jedinice_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_uredjivanje_terenske_jedinice_test() throws Exception {
