...
public class PX_DIST_Izmjena_Terenske_Jedinice_Test extends BaseTest {
	
	public PX_DIST_Izmjena_Terenske_Jedinice_Test() throws IOException, FileNotFoundException {
		super();
	}
