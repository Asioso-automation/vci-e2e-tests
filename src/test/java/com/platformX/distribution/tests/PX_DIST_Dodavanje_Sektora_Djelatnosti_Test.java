...
public class PX_DIST_Dodavanje_Sektora_Djelatnosti_Test extends BaseTest {
	
	public PX_DIST_Dodavanje_Sektora_Djelatnosti_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_dodavanje_sektora_djelatnosti_test() throws Exception {
