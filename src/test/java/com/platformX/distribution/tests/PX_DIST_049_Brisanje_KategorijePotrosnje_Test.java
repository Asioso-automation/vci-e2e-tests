...
public class PX_DIST_049_Brisanje_KategorijePotrosnje_Test extends BaseTest{

	public PX_DIST_049_Brisanje_KategorijePotrosnje_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_049_brisanje_kategorijepotrosnje_test() throws Exception {
		...
		homePage.verifikujBrisanjeStavke(true, kategorijaPotrosnje);
	}
