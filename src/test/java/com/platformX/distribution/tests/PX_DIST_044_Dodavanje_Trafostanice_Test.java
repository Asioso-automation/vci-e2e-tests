...
public class PX_DIST_044_Dodavanje_Trafostanice_Test extends BaseTest {

	public PX_DIST_044_Dodavanje_Trafostanice_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_044_dodavanje_trafostanice_test() throws Exception {
