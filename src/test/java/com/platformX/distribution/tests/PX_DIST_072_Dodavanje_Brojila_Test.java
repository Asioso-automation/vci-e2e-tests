...
public class PX_DIST_072_Dodavanje_Brojila_Test  extends BaseTest {

	public PX_DIST_072_Dodavanje_Brojila_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_072_dodavanje_brojila_test() throws Exception {
