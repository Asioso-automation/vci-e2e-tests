...
public class PX_DIST_031_Brisanje_Naseljenog_Mjesta_Test extends BaseTest {

	public PX_DIST_031_Brisanje_Naseljenog_Mjesta_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_031_brisanje_naseljenog_mjesta_test() throws Exception {
		...
		homePage.verifikujBrisanjeStavke(true, naseljenoMjesto);
	}
