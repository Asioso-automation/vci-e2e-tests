...
public class PX_DIST_Dodavanje_Fizicke_Lokacije_Test extends BaseTest {
	
	public PX_DIST_Dodavanje_Fizicke_Lokacije_Test() throws IOException, FileNotFoundException {
		super();
	}
