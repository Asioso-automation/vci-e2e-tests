...
public class PX_DIST_002_Provjera_Validacija_Na_LogIn_Formi_Test extends BaseTest {
	...
	@Test (retryAnalyzer = RetryAnalyzer.class, description="pogresna lozinka")
	...
	@Test (retryAnalyzer = RetryAnalyzer.class, description="pogrešno korisničko ime")
	...
	@Test (retryAnalyzer = RetryAnalyzer.class, description="pogrešno korisničko ime i lozinka")
