...
public class PX_DIST_018_Naseljena_Mjesta_CRUD_Test extends BaseTest{

	public PX_DIST_018_Naseljena_Mjesta_CRUD_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_018_1_dodavanje_naseljenog_mjesta_test() throws Exception {
	...
	@Test
	public void px_dist_018_2_uredjivanje_naseljenog_mjesta_test() throws Exception {
		LogIn logIn = new LogIn(driver, PLATFORMX_DISTRIBUTION_PROPERTIES);
		logIn.verifikujLogIn();
		logIn.logIn();
		PocetnaStranicaPXD homePage = new PocetnaStranicaPXD(driver);
	...
	@Test
	public void px_dist_018_3_brisanje_naseljenog_mjesta_test() throws Exception {
		LogIn logIn = new LogIn(driver, PLATFORMX_DISTRIBUTION_PROPERTIES);
		logIn.verifikujLogIn();
		logIn.logIn();
		PocetnaStranicaPXD homePage = new PocetnaStranicaPXD(driver);
