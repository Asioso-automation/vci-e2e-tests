...
public class PX_DIST_068_Brisanje_Pravnog_Lica_Test  extends BaseTest {

	public PX_DIST_068_Brisanje_Pravnog_Lica_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_068_brisanje_pravnog_lica_test() throws Exception {
		...
		pravnaLicaPage.verifikujBrisanjeStavke(true, pravnaLica);
	}
