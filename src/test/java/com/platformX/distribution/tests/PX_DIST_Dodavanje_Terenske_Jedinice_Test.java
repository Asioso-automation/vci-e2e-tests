...
public class PX_DIST_Dodavanje_Terenske_Jedinice_Test extends BaseTest {
	
	public PX_DIST_Dodavanje_Terenske_Jedinice_Test() throws IOException, FileNotFoundException {
		super();
	}
