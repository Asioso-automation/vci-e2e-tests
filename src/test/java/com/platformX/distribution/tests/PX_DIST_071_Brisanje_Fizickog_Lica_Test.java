...
public class PX_DIST_071_Brisanje_Fizickog_Lica_Test  extends BaseTest {

	public PX_DIST_071_Brisanje_Fizickog_Lica_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_071_brisanje_fizickog_lica_test() throws Exception {
		...
		fizickaLicaPage.verifikujBrisanjeStavke(true, fizickaLica);
	}
