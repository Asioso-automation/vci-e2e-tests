...
public class PX_DIST_011_Monteri_CRUD_Test extends BaseTest {
	...
	String noviMonter = "NoviMonter " + Helper.getRandomString(4);
	...
	public void px_dist_011_1_dodavanje_montera_test() throws Exception {
		...
		monteri.verifikacijaStranice("Šifarnici", "Monteri", "Monteri", 1, monteri.columns, monteri.buttons);
		monteri.verifikujStavku(monter, homePage.podatak2Tabela2WE);
	}
	
	@Test (retryAnalyzer = RetryAnalyzer.class, dependsOnMethods = { "px_dist_011_1_dodavanje_montera_test" })
	...
	@Test (retryAnalyzer = RetryAnalyzer.class, dependsOnMethods = { "px_dist_011_2_uredjivanje_montera_test" })
