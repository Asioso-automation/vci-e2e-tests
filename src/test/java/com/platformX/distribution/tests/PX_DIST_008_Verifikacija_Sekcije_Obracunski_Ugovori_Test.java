...
public class PX_DIST_008_Verifikacija_Sekcije_Obracunski_Ugovori_Test extends BaseTest {

	public PX_DIST_008_Verifikacija_Sekcije_Obracunski_Ugovori_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test(description = "test prolazi kroz sve stranice iz sekcije OBRACUNSKI UGOVORI i verifikuje ih")
	public void px_dist_007_verifikacija_sekcije_obracunski_ugovori_test() throws Exception {
