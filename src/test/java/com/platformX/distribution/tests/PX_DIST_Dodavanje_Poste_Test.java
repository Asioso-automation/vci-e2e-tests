...
public class PX_DIST_Dodavanje_Poste_Test extends BaseTest {

	public PX_DIST_Dodavanje_Poste_Test() throws IOException, FileNotFoundException {
		super();
	}
	...
	@Test
	public void px_dist_dodavanje_poste_test() throws Exception {
