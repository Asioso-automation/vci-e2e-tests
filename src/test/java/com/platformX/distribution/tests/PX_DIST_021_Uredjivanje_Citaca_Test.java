...
public class PX_DIST_021_Uredjivanje_Citaca_Test extends BaseTest {
	
	public PX_DIST_021_Uredjivanje_Citaca_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_021_uredjivanje_citaca_test() throws Exception {
