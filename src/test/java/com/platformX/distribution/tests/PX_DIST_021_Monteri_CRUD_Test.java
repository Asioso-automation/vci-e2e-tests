...
public class PX_DIST_021_Monteri_CRUD_Test extends BaseTest {

	public PX_DIST_021_Monteri_CRUD_Test() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_021_1_dodavanje_montera_test() throws Exception {
	...
	@Test
	public void px_dist_021_2_uredjivanje_montera_test() throws Exception {
		LogIn logIn = new LogIn(driver, PLATFORMX_DISTRIBUTION_PROPERTIES);
		logIn.verifikujLogIn();
		logIn.logIn();
		PocetnaStranicaPXD homePage = new PocetnaStranicaPXD(driver);
	...
	@Test
	public void px_dist_021_3_brisanje_montera_test() throws Exception {
		LogIn logIn = new LogIn(driver, PLATFORMX_DISTRIBUTION_PROPERTIES);
		logIn.verifikujLogIn();
		logIn.logIn();
		PocetnaStranicaPXD homePage = new PocetnaStranicaPXD(driver);
