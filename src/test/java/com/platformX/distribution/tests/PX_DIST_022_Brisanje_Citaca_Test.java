...
public class PX_DIST_022_Brisanje_Citaca_Test extends BaseTest {
	
	public PX_DIST_022_Brisanje_Citaca_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_022_brisanje_citaca_test() throws Exception {
