...
public class PX_DIST_Dodavanje_Zbirnog_Kontrolnog_Mjernog_Mjesta extends BaseTest {
	
	public PX_DIST_Dodavanje_Zbirnog_Kontrolnog_Mjernog_Mjesta() throws IOException, FileNotFoundException {
		super();
	}

	@Test
	public void px_dist_dodavanje_zbirnog_kontrolnog_mjernog_mjesta_test() throws Exception {
