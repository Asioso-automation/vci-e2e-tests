...
public class PX_DIST_Izmjena_Elektroenergetske_Saglasnosti_Test extends BaseTest {

	public PX_DIST_Izmjena_Elektroenergetske_Saglasnosti_Test() throws IOException, FileNotFoundException {
		super();
	}
		@Test
		public void px_dist_dodavanje_elektroenergetske_saglasnosti_test() throws Exception {
			...
			elSaglasnosti.izmjeniElektroenergetskuSaglasnost();
	}
