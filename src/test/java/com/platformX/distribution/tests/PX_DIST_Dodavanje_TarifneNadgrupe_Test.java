...
public class PX_DIST_Dodavanje_TarifneNadgrupe_Test extends BaseTest{

	public PX_DIST_Dodavanje_TarifneNadgrupe_Test() throws IOException, FileNotFoundException {
		super();
	}
	@Test
	public void px_dist_dodavanje_tarifnenadgrupe_test() throws Exception {
