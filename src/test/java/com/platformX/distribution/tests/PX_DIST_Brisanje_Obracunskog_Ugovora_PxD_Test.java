...
public class PX_DIST_Brisanje_Obracunskog_Ugovora_PxD_Test  extends BaseTest {

	public PX_DIST_Brisanje_Obracunskog_Ugovora_PxD_Test() throws IOException, FileNotFoundException {
		super();
	}
	
	@Test
	public void px_dist_brisanje_obracunskog_ugovora_pxd_test() throws Exception {
		...
		obracunskiUgovoriPage.verifikujObrisanObracunskiUgovor(mjernoMjesto);
	}
}
