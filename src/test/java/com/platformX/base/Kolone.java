...
public class Kolone extends PageBase {
	...
	@FindBy(xpath = "//*[contains(@class, 'v-data-table-header')]//*[text() = 'Zahtjevani datum isključenja']")
	...
	@FindBy(xpath = "//*[contains(@class, 'v-data-table-header')]//*[text() = 'Zahtjevani datum uključenja']")
	...
	@FindBy(xpath = "//*[contains(@class, 'v-data-table-header')]//*[text() = 'Trafo stanica']")
	...
	@FindBy(xpath = "//*[contains(@class, 'v-data-table-header')]//*[text() = 'Redni broj izlaza na trafo stanici']")
